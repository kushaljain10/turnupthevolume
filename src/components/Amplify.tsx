...
const tiles = [
  { icon: Hammer, title: "Workers", caption: "Fair pay, dignity, protection." },
  {
    icon: Train,
    title: "Transit",
    caption: "Mobility as a right, not a luxury.",
  },
  {
    icon: Users,
    title: "Belonging",
    caption:
      "Immigrants, trans folks, and every neighbour who’s been told to keep it down.",
  },
];
...
export function Amplify() {
  return (
    <section className="container section">
      <h2 className="heading text-2xl md:text-3xl font-bold mb-6">
        What we amplify
      </h2>
