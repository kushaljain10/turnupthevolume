export function Cta() {
  return (
    <section className="relative py-16 bg-ctaGradient" aria-label="Call to Action">
      <div className="container">
        <h2 className="heading text-3xl md:text-4xl font-extrabold">If they turn it up, we turn up louder.</h2>
        <div className="mt-6 flex flex-wrap items-center gap-3">
          <a href="#token" className="inline-flex items-center rounded bg-black px-4 py-2 font-semibold text-electricRed hover:opacity-90">Get $VOLUME</a>
